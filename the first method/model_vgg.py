...
def Siamese_net():
    ...
    feature_b1 = Dropout(0.5)(feature1)
    feature_b1_1 = Dense(1024, activation='relu')(feature_b1)
    feature_b1 = Dropout(0.5)(feature_b1_1)
    out_b1 = Dense(1, activation='sigmoid')(feature_b1)

    # branch2
    feature2 = Flatten()(feature2)
    feature_b2 = Dropout(0.5)(feature2)
    feature_b2_1 = Dense(1024, activation='relu')(feature_b2)
    feature_b2 = Dropout(0.5)(feature_b2_1)
    out_b2 = Dense(1, activation='sigmoid')(feature_b2)
    #branch3
    feature=concatenate([feature1,feature2])
    feature = Flatten()(feature)
    feature=Dropout(0.5)(feature)
    feature=Dense(1024,activation='relu')(feature)
    feature = concatenate([feature,feature_b1_1,feature_b2_1])
    feature = Flatten()(feature)
    feature = Dropout(0.5)(feature)
    feature=Dense(1024,activation='relu')(feature)
    feature = Dropout(0.5)(feature)
    out=Dense(1,activation='sigmoid')(feature)
    model = Model(inputs=[img1,img2], outputs=[out,out_b1,out_b2])
    ...
    model.compile(optimizer=adam, loss=[losses.binary_crossentropy,losses.binary_crossentropy,losses.binary_crossentropy], metrics=[metrics.binary_accuracy])
    return model
