...
def main():
    ...
    model.load_weights("F:/pc/change_detection_tf/check_points/contrastiveloss/weights-improvement-03.hdf5")
    preds=[]
    trues=[]
    ...
    table.to_csv(savepath + '/confusion_matrixs_contrastiveloss.csv')
