...
from read_data_exp11 import *
from model_exp11 import getModel
import pandas as pd
...
def main():
    ...
    model.load_weights("F:/pc/change_detection_tf/check_points/exp11/weights-improvement-02.hdf5")
    preds=[]
    trues=[]
    ...
    for i in range(test_set.shape[0]):
        ...
        maska,_,_ = model.predict([img1_1, img2_1])
        maskb,_,_  = model.predict([img1_2, img2_2])
        maskc,_,_  = model.predict([img1_3, img2_3])
        maskd,_,_  = model.predict([img1_4, img2_4])
    ...
    table.to_csv(savepath + '/confusion_matrixs_exp11.csv')
